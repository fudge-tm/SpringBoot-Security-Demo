...
<div class="main-wrapper">
                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a class="active" href="salary_insert.jsp">新增员工工资信息</a></li>
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">新增员工工资</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="card-box">
                        <h4 class="card-title">新增员工工资信息</h4>
                        <form action="/admin/salary/add" id="salaryinsform">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">员工 ID</label>
                                <div class="col-md-9">
                                    <input required type="text" class="form-control" maxlength="3" name="salaryeid"
                                           id="addsalaryeID">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input required type="text" class="form-control" maxlength="3" name="salarytid"
                                           id="addsalarytID">
                                    <span id="salarytid_err" class="err_msg" style="color: red"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">员工工资</label>
                                <div class="col-md-9">
...
<script>
    ...
    function checksmoney() {
        ...
        if (flag) {
            ...
            //不合规则
            document.getElementById("smoney_err").innerText = '工资金额需为零或者非零开头的正整数';
            smoneyInput.value = '';
        }
        return flag;
    }
    ...
    function checkandsubmit() {
        ...
        if (evalue != null && tvalue != null) {
            axios({
                method: "get",
                url: "http://localhost:8080/admin/salary/add?flag=true&salaryeid=" + evalue + "&salarytid=" + tvalue
                // http://localhost:8080/admin/salary/add?salaryeid=eee&salarytid=sss&salarymoney=4563
            }).then(function (resp) {
                if (resp.data == "fail") {//fail表示已存在
                    ...
                    exitedID = true;
                    // console.log(checksmoney() + "%%" + exitedID);
                    if (checksmoney() && exitedID) {
                        // alert("sss")
                        document.getElementById("salaryinsform").submit();
                    }
