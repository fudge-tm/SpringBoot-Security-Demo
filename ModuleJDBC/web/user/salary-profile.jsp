                ...
                <ul>
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a class="active"
                                   href="${pageContext.request.contextPath}/user/employee/selectEmployeeSalaryInfo">个人工资信息</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/user/employee/selectEmployeeTitleInfo">个人职位信息</a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            <h3 class="user-name m-t-0 mb-0">员工 ID : ${salary.eid}</h3>
                                            <small class="text-muted"></small>
                                            <div class="staff-id">职位 ID : ${salary.tid}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <span class="text">${salary.smoney}</span>
                                            </li>
                                            <li>
                                                <span class="title">工资标志位</span>
                                                <span class="text">${salary.flag}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
